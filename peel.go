...
func Peel(ctx context.Context, r *Robot) error {
	...
	if err := r.moveFree(ctx, "apple-arm", abovePeeler, nil); err != nil {
	...
	if err := r.moveLinear(ctx, "apple-arm", jawsPose, nil, 1); err != nil {
	...
	if err := r.moveLinear(ctx, "apple-arm", spikePose, nil, 1); err != nil {
	...
	if err := r.moveLinear(ctx, "apple-arm", abovePeeler, nil, 1); err != nil {
